...
What I did
Clustering (K-Means) grouped customers into 5 segments based on income and spending score. Picked k=5 using the elbow method and silhouette score (0.555).
Regression tried to predict Spending Score from Age and Income, with full diagnostics (R², p-values, VIF, residuals).
Results
